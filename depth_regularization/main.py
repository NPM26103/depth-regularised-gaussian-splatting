...
from depth_regularization.proj_utils import create_depth_maps_midas, project_points_to_cameras, find_optimal_offset_scale
import numpy as np
...
def preprocess_depth(dataset_path):
    ...
    depth_maps = create_depth_maps_midas(dataset_path, save=True)
